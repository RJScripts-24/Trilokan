...
export function Dashboard({ userName = "Sudhanshu", onLogout }: DashboardProps) {
  const [currentView, setCurrentView] = useState('dashboard');
  const [exploreSection, setExploreSection] = useState<'identity' | 'appchecker' | 'compliant' | null>(null);

  const navItems = [
    { icon: Home, label: 'Dashboard', active: true, view: 'dashboard' },
    { icon: Compass, label: 'Explore', active: false, view: 'explore' },
    { icon: Newspaper, label: 'News', active: false, view: 'news' },
    { icon: Wallet, label: 'Wallet', active: false, view: 'wallet' },
    { icon: Settings, label: 'Setting', active: false, view: 'settings' },
    { icon: HelpCircle, label: 'Support', active: false, view: 'support' },
  ];
  ...
  const stats = [
    { label: 'Total Users', value: '24.5K', change: '+12.5%', icon: Users, color: '#10B981' },
    { label: 'Active Sessions', value: '1,429', change: '+8.2%', icon: Activity, color: '#3B82F6' },
    { label: 'Revenue', value: '₹12.4L', change: '+23.1%', icon: DollarSign, color: '#D3AF37' },
    { label: 'Growth Rate', value: '87%', change: '+5.4%', icon: TrendingUp, color: '#8B5CF6' },
  ];
  ...
  if (currentView === 'settings') {
    return <SettingsPage userName={userName} onBack={() => setCurrentView('dashboard')} />;
  }
    ...
    return (
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 p-10">
          ...
          {exploreSection === 'identity' && <IdentityVerification />}
          {exploreSection === 'appchecker' && <AppChecker />}
          {exploreSection === 'compliant' && <CompliantPortal />}
        </div>
      </div>
    );
  }
            ...
            {exploreOptions.map((option, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <motion.div
                    className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${option.gradient} flex items-center justify-center mb-6`}
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute bottom-[10%] left-[50%] w-[550px] h-[550px] rounded-full blur-3xl"
          style={{ backgroundColor: '#D3AF37' }}
        />
